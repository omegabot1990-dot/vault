...
- [ ] 6) Tequila: Trapping-free Ternary Quantization for Large Language Models — https://arxiv.org/abs/2509.23809
- [ ] summary: Quantization techniques are essential for the deployment of Large Language Models (LLMs) on edge devices
- [ ] 7) Turning the TIDE: Cross-Architecture Distillation for Diffusion Large Language Models — https://arxiv.org/abs/2604.26951
- [ ] summary: Diffusion large language models (dLLMs) offer parallel decoding and bidirectional context, but state-of-the-art dLLMs require billions of parameters for competitive performance
