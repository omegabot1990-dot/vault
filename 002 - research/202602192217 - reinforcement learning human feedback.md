...
- A typical RLHF pipeline has [[202601282201 - supervised fine-tuning|supervised fine-tuning]], reward-model training from preference rankings, and then policy optimization
