...
- Attention is a mechanism that lets each token weight information from other tokens based on relevance
...
- Scaled dot-product attention uses softmax-normalized similarity scores to form weighted sums
