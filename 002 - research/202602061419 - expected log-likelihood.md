...
- If we have a true [[202602072325 - distribution|distribution]] $p(x)$ and a model distribution $q(x|\theta)$, the expected log-likelihood is written as,
...
- This is the core of [[202602120102 - cross-entropy|cross-entropy]]

> [!MATH] Cross-Entropy and Log-Likelihood
> $$H(p, q) = -E_{p}[\log q]$$
