...
---
- A neural network is a machine learning [[202602010044 - model|model]] that stacks simple "neurons" in layers and learns pattern-recognising [[202602111358 - weights and biases|weights and biases]] from data to map inputs to outputs [^1]
...
- [[202602111314 - model parameters|Parameters]] are learned from data using [[202602111557 - backpropagation|backpropagation]] and gradient-based [[202602111605 - optimization algorithms|optimization]]
...
- Once the gradient is calculated, we update the weight using the [[202602111600 - learning rate|learning rate]] ($\eta$), which is a [[202602111256 - hyperparameters|hyperparameter]]:
...
[^2]: [But what is a neural network? | Deep learning chapter 1](https://www.youtube.com/watch?v=aircAruvnKk&list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi)