...
- Supervised learning [[202602111335 - training|trains]] a [[202602010044 - model|model]] from labeled pairs $(x,y)$ to predict targets from inputs
...
- Generalisation quality depends on data quality, model capacity, regularization, and optimization setup