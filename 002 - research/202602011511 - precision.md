...
- The <mark style="background: #FFF3A3A6;">proportion of positive predictions that were actually correct</mark>

> [!MATH] Precision
> $$\text{Precision} = \frac{\text{True Positives}}{\text{True Positives} + \text{False Positives}}$$

- <mark style="background: #BBFABBA6;">Precision and recall often have an inverse relationship</mark>; increasing one often decreases the other
