...
- It avoids learning $P(s'\mid s,a)$ and instead estimates [[202602192359 - value estimation|value functions]], policies, or both
...
- It is often simpler to deploy, but may require more [[202602192345 - environment|environment]] interactions than [[202602201253 - model-based|environment]] methods
- Experience replay, target networks, and advantage estimation are common stabilising techniques
