...
- Autoregressive refers to a <mark style="background: #FF5582A6;">modelling technique</mark> where a future value or component in a sequence is predicted based on its own past values
