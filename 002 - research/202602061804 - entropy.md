...
- It is the [[202602061333 - expectation|expected]] value of the information content across all possible outcomes:
...
- For a continuous random variable $X$ with a [[202602091301 - probability density function|probability density function (PDF)]] $f(x)$:
